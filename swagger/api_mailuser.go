...
*/
func (a *MailuserApiService) MailuserCreate(ctx context.Context, body []MailUserCreate) ([]MailUserResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/mailuser/create/"
...
*/
func (a *MailuserApiService) MailuserDelete(ctx context.Context, body []MailUserDelete) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/mailuser/delete/"
...
@return []MailUserResponse
*/
func (a *MailuserApiService) MailuserList(ctx context.Context) ([]MailUserResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/mailuser/list/"
...
@return MailUserResponse
*/
func (a *MailuserApiService) MailuserRead(ctx context.Context, uuid string) (MailUserResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/mailuser/read/{uuid}"
...
@return []MailUserResponse
*/
func (a *MailuserApiService) MailuserUpdate(ctx context.Context, body []MailUserUpdate) ([]MailUserResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/mailuser/update/"
...
@return []MailUserResponse
*/
func (a *MailuserApiService) MailuserUpdatePublic(ctx context.Context, body []MailUserUpdatePublic) ([]MailUserResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/mailuser/update_public/"
