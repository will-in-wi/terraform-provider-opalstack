 ...
 * @param optional nil or *SchemaApiSchemaRetrieveOpts - Optional Parameters:
     * @param "Format" (optional.String) -
     * @param "Lang" (optional.String) -
@return map[string]interface{}
*/

type SchemaApiSchemaRetrieveOpts struct {
	Format optional.String
	Lang   optional.String
}

func (a *SchemaApiService) SchemaRetrieve(ctx context.Context, localVarOptionals *SchemaApiSchemaRetrieveOpts) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/schema/"
