...
@return []CertResponse
*/
func (a *CertApiService) CertCreate(ctx context.Context, body []CertCreate) ([]CertResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/cert/create/"
...
*/
func (a *CertApiService) CertDelete(ctx context.Context, body []CertRead) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/cert/delete/"
...
@return []CertResponse
*/
func (a *CertApiService) CertList(ctx context.Context) ([]CertResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/cert/list/"
...
@return CertResponse
*/
func (a *CertApiService) CertRead(ctx context.Context, uuid string) (CertResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/cert/read/{uuid}"
...
*/
func (a *CertApiService) CertShared(ctx context.Context) (SharedCertResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/cert/shared/"
...
@return []CertResponse
*/
func (a *CertApiService) CertUpdate(ctx context.Context, body []CertUpdate) ([]CertResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/cert/update/"
