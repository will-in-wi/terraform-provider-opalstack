...
*/
func (a *ServerApiService) ServerList(ctx context.Context) (ServerListResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/server/list/"
...
*/
func (a *ServerApiService) ServerRead(ctx context.Context, uuid string) (WebServerReadResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/server/read/{uuid}"
