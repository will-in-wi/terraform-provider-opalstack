...
*/
func (a *TokenApiService) TokenCreate(ctx context.Context, body []TokenCreate) ([]TokenResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/token/create/"
...
*/
func (a *TokenApiService) TokenDelete(ctx context.Context, body []TokenRead) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/token/delete/"
...
@return []TokenResponse
*/
func (a *TokenApiService) TokenList(ctx context.Context) ([]TokenResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/token/list/"
...
@return TokenResponse
*/
func (a *TokenApiService) TokenRead(ctx context.Context, key string) (TokenResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/token/read/{key}"
...
@return []TokenResponse
*/
func (a *TokenApiService) TokenUpdate(ctx context.Context, body []TokenUpdate) ([]TokenResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/token/update/"
