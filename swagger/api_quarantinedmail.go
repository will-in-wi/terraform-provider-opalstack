...
type QuarantinedmailApiService service

/*
QuarantinedmailApiService
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body

*/
func (a *QuarantinedmailApiService) QuarantinedmailDelete(ctx context.Context, body []QuarantinedMailRead) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/quarantinedmail/delete/"
...
QuarantinedmailApiService
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []QuarantinedMailResponse
*/
func (a *QuarantinedmailApiService) QuarantinedmailList(ctx context.Context) ([]QuarantinedMailResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue []QuarantinedMailResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/quarantinedmail/list/"
...
@return QuarantinedMailResponse
*/
func (a *QuarantinedmailApiService) QuarantinedmailRead(ctx context.Context, uuid string) (QuarantinedMailResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/quarantinedmail/read/{uuid}"
...
@return []QuarantinedMailResponse
*/
func (a *QuarantinedmailApiService) QuarantinedmailSubmit(ctx context.Context, body []QuarantinedMailUpdate) ([]QuarantinedMailResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/quarantinedmail/submit/"
