...
*/
func (a *AppApiService) AppCreate(ctx context.Context, body []ApplicationCreate) ([]ApplicationResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/app/create/"
...
*/
func (a *AppApiService) AppDelete(ctx context.Context, body []ApplicationRead) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/app/delete/"
...
*/
func (a *AppApiService) AppFailed(ctx context.Context, body []ApplicationInstalledRequest) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/app/failed/"
...
*/
func (a *AppApiService) AppInstalled(ctx context.Context, body []ApplicationInstalledRequest) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/app/installed/"
...
@return []ApplicationResponse
*/
func (a *AppApiService) AppList(ctx context.Context) ([]ApplicationResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/app/list/"
...
@return ApplicationResponse
*/
func (a *AppApiService) AppRead(ctx context.Context, uuid string) (ApplicationResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/app/read/{uuid}"
...
@return []ApplicationResponse
*/
func (a *AppApiService) AppUpdate(ctx context.Context, body []ApplicationUpdate) ([]ApplicationResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/app/update/"
