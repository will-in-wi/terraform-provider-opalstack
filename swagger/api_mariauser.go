...
*/
func (a *MariauserApiService) MariauserCreate(ctx context.Context, body []MariaUserCreate) ([]MariaUserResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/mariauser/create/"
...
*/
func (a *MariauserApiService) MariauserDelete(ctx context.Context, body []MariaUserRead) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/mariauser/delete/"
...
@return []MariaUserResponse
*/
func (a *MariauserApiService) MariauserList(ctx context.Context) ([]MariaUserResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/mariauser/list/"
...
@return MariaUserResponse
*/
func (a *MariauserApiService) MariauserRead(ctx context.Context, uuid string) (MariaUserResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/mariauser/read/{uuid}"
...
@return []MariaUserResponse
*/
func (a *MariauserApiService) MariauserUpdate(ctx context.Context, body []MariaUserUpdate) ([]MariaUserResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/mariauser/update/"
