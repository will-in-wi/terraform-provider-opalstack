...
*/
func (a *LoginApiService) Login(ctx context.Context, body Signin) (SigninResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/login/"
