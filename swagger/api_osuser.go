...
*/
func (a *OsuserApiService) OsuserCreate(ctx context.Context, body []OsUserCreate) ([]OsUserResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/osuser/create/"
...
*/
func (a *OsuserApiService) OsuserDelete(ctx context.Context, body []OsUserRead) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/osuser/delete/"
...
@return []OsUserResponse
*/
func (a *OsuserApiService) OsuserList(ctx context.Context) ([]OsUserResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/osuser/list/"
...
@return OsUserResponse
*/
func (a *OsuserApiService) OsuserRead(ctx context.Context, uuid string) (OsUserResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/osuser/read/{uuid}"
...
@return []OsUserResponse
*/
func (a *OsuserApiService) OsuserUpdate(ctx context.Context, body []OsUserUpdate) ([]OsUserResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/osuser/update/"
