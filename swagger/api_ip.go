...
*/
func (a *IpApiService) IpList(ctx context.Context) ([]IpAddressResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/ip/list/"
...
@return IpAddressResponse
*/
func (a *IpApiService) IpRead(ctx context.Context, uuid string) (IpAddressResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/ip/read/{uuid}"
