...
*/
func (a *PsqldbApiService) PsqldbCreate(ctx context.Context, body []PsqlDbCreate) ([]PsqlDbResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/psqldb/create/"
...
*/
func (a *PsqldbApiService) PsqldbDelete(ctx context.Context, body []PsqlDbRead) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/psqldb/delete/"
...
@return []PsqlDbResponse
*/
func (a *PsqldbApiService) PsqldbList(ctx context.Context) ([]PsqlDbResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/psqldb/list/"
...
@return PsqlDbResponse
*/
func (a *PsqldbApiService) PsqldbRead(ctx context.Context, uuid string) (PsqlDbResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/psqldb/read/{uuid}"
...
@return []PsqlDbResponse
*/
func (a *PsqldbApiService) PsqldbUpdate(ctx context.Context, body []PsqlDbUpdate) ([]PsqlDbResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/psqldb/update/"
