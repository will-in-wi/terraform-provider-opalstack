...
@return []SiteResponse
*/
func (a *SiteApiService) SiteCreate(ctx context.Context, body []SiteCreate) ([]SiteResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/site/create/"
...
*/
func (a *SiteApiService) SiteDelete(ctx context.Context, body []SiteRead) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/site/delete/"
...
@return []SiteResponse
*/
func (a *SiteApiService) SiteList(ctx context.Context) ([]SiteResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/site/list/"
...
@return SiteResponse
*/
func (a *SiteApiService) SiteRead(ctx context.Context, uuid string) (SiteResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/site/read/{uuid}"
...
@return []SiteResponse
*/
func (a *SiteApiService) SiteUpdate(ctx context.Context, body []SiteUpdate) ([]SiteResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/site/update/"
