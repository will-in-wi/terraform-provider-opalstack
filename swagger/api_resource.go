...
*/
func (a *ResourceApiService) ResourceImapUpdateCreate(ctx context.Context) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/resource/imap/update/"
