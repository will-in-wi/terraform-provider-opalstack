...
*/
func (a *OsvarApiService) OsvarCreate(ctx context.Context, body []OsVarCreate) ([]OsVarResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/osvar/create/"
...
*/
func (a *OsvarApiService) OsvarDelete(ctx context.Context, body []OsVarRead) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/osvar/delete/"
...
@return []OsVarResponse
*/
func (a *OsvarApiService) OsvarList(ctx context.Context) ([]OsVarResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/osvar/list/"
...
@return OsVarResponse
*/
func (a *OsvarApiService) OsvarRead(ctx context.Context, uuid string) (OsVarResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/osvar/read/{uuid}"
...
@return []OsVarResponse
*/
func (a *OsvarApiService) OsvarUpdate(ctx context.Context, body []OsVarUpdate) ([]OsVarResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/osvar/update/"
