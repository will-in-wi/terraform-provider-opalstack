...
// List of StateEnum
const (
	READY_StateEnum          StateEnum = "READY"
	PENDING_CREATE_StateEnum StateEnum = "PENDING_CREATE"
	PENDING_UPDATE_StateEnum StateEnum = "PENDING_UPDATE"
	PENDING_DELETE_StateEnum StateEnum = "PENDING_DELETE"
)
