...
*/
func (a *PsqluserApiService) PsqluserCreate(ctx context.Context, body []PsqlUserCreate) ([]PsqlUserResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/psqluser/create/"
...
*/
func (a *PsqluserApiService) PsqluserDelete(ctx context.Context, body []PsqlUserRead) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/psqluser/delete/"
...
@return []PsqlUserResponse
*/
func (a *PsqluserApiService) PsqluserList(ctx context.Context) ([]PsqlUserResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/psqluser/list/"
...
@return PsqlUserResponse
*/
func (a *PsqluserApiService) PsqluserRead(ctx context.Context, uuid string) (PsqlUserResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/psqluser/read/{uuid}"
...
@return []PsqlUserResponse
*/
func (a *PsqluserApiService) PsqluserUpdate(ctx context.Context, body []PsqlUserUpdate) ([]PsqlUserResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/psqluser/update/"
