...
*/
func (a *MariadbApiService) MariadbCreate(ctx context.Context, body []MariaDbCreate) ([]MariaDbResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/mariadb/create/"
...
*/
func (a *MariadbApiService) MariadbDelete(ctx context.Context, body []MariaDbRead) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/mariadb/delete/"
...
@return []MariaDbResponse
*/
func (a *MariadbApiService) MariadbList(ctx context.Context) ([]MariaDbResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/mariadb/list/"
...
@return MariaDbResponse
*/
func (a *MariadbApiService) MariadbRead(ctx context.Context, uuid string) (MariaDbResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/mariadb/read/{uuid}"
...
@return []MariaDbResponse
*/
func (a *MariadbApiService) MariadbUpdate(ctx context.Context, body []MariaDbUpdate) ([]MariaDbResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/mariadb/update/"
