...
*/
func (a *DnsrecordApiService) DnsrecordCreate(ctx context.Context, body []DnsRecordCreate) ([]DnsRecordResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/dnsrecord/create/"
...
*/
func (a *DnsrecordApiService) DnsrecordDelete(ctx context.Context, body []DnsRecordRead) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/dnsrecord/delete/"
...
@return []DnsRecordResponse
*/
func (a *DnsrecordApiService) DnsrecordList(ctx context.Context) ([]DnsRecordResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/dnsrecord/list/"
...
@return DnsRecordResponse
*/
func (a *DnsrecordApiService) DnsrecordRead(ctx context.Context, uuid string) (DnsRecordResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/dnsrecord/read/{uuid}"
...
@return []DnsRecordResponse
*/
func (a *DnsrecordApiService) DnsrecordUpdate(ctx context.Context, body []DnsRecordUpdate) ([]DnsRecordResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/dnsrecord/update/"
