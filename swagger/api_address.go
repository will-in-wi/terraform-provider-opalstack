...
*/
func (a *AddressApiService) AddressCreate(ctx context.Context, body []VirtualAliasCreate) ([]VirtualAliasResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/address/create/"
...
*/
func (a *AddressApiService) AddressDelete(ctx context.Context, body []VirtualAliasRead) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/address/delete/"
...
@return []VirtualAliasResponse
*/
func (a *AddressApiService) AddressList(ctx context.Context) ([]VirtualAliasResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/address/list/"
...
@return VirtualAliasResponse
*/
func (a *AddressApiService) AddressRead(ctx context.Context, uuid string) (VirtualAliasResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/address/read/{uuid}"
...
@return []VirtualAliasResponse
*/
func (a *AddressApiService) AddressUpdate(ctx context.Context, body []VirtualAliasUpdate) ([]VirtualAliasResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/address/update/"
