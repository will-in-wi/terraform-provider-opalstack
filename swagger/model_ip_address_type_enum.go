...
const (
	// SWAGGERMOD: Autogenerated enums started with a number, which is invalid in Golang.
	// Reported in https://github.com/swagger-api/swagger-codegen/issues/11615
	v4__IpAddressTypeEnum IpAddressTypeEnum = "4"
	v6__IpAddressTypeEnum IpAddressTypeEnum = "6"
)
